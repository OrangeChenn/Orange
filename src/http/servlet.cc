...
int32_t FunctionServlet::handle(orange::http::HttpRequest::ptr request
...
int32_t ServletDispatch::handle(orange::http::HttpRequest::ptr request
                , orange::http::HttpResponse::ptr response
                , orange::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(orange::http::HttpRequest::ptr request
                , orange::http::HttpResponse::ptr response
                , orange::http::HttpSession::ptr session) {
    static std::string RSP_BODY = "<html><head><title>404 Not Found"
